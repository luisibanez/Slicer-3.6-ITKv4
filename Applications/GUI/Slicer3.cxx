/*=========================================================================
  ...
  Date:      $Date: 2010-08-10 15:11:46 -0400 (Tue, 10 Aug 2010) $
  Version:   $Revision: 14521 $
...
void printAllInfo(int argc, char **argv)
{
  ...
  fprintf(stdout, "<ProgramName version=\"$Revision: 14521 $\">%s</ProgramName>\n", argv[0]);
...
#endif
  fprintf(stdout, "<Repository>$HeadURL: http://svn.slicer.org/Slicer3/trunk/Applications/GUI/Slicer3.cxx $</Repository>\n");
  fprintf(stdout, "<ProcessStep>\n");
  fprintf(stdout, "\n");
}
